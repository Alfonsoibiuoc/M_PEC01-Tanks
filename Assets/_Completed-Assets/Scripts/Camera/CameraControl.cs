...
namespace Complete
{
    public class CameraControl : MonoBehaviour
    {
		...
		private void Split() {
            //Consultamos la lista de tanques de "GameManager"
            float distance = Vector3.Distance(GameManager.tanks[0].transform.position, GameManager.tanks[1].transform.position);
        ...
        private void FindAveragePosition()
        {
            ...
            for (int i = 0; i < GameManager.numJugadores; i++)
            {
                //Debug.Log(i);
